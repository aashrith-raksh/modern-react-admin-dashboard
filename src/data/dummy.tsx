...
export const gridOrderStatus: FC<{ StatusBg: string; Status: string }> = (
  props
) => (
  <button
    type="button"
...
const gridEmployeeProfile: FC<{ EmployeeImage: string; Name: string }> = (
  props
) => (
...
const customerGridStatus: FC<{ StatusBg: string; Status: string }> = (
  props
) => (
